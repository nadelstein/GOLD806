...
Based on our analysis, it seems that some hurricanes have made landfall before
June (in May), and also after November (in December). To confirm whether this
data involves US landfall we can produce a map like the one below:
